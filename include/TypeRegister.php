...
require_once('../include/RankObjectType.php');
...
class TypeRegister {
    ...
    public static function rankObjectType(){
        return self::$rankObjectType ?: (self::$rankObjectType = new RankObjectType());
    }
